...
java -cp "target/classes;target/dependency/*" com.hypervector.benchmark.BenchmarkRunner synthetic

Write-Host "Running WordNet benchmark..." -ForegroundColor Green
java -cp "target/classes;target/dependency/*" com.hypervector.benchmark.BenchmarkRunner wordnet

Write-Host "Running deep hierarchy benchmark..." -ForegroundColor Green
java -cp "target/classes;target/dependency/*" com.hypervector.benchmark.BenchmarkRunner deep
